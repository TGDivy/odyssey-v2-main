...
| A-005 | Apple signing, HealthKit entitlements, and physical-device checks happen on the owner's Mac. | Deployment handoff and capability report prove configuration. | Active |
