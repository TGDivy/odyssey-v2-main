...
.PHONY: help diagnostics bootstrap dev stop verify format lint test schemas fixtures infra-check rebuild-projections apple-project clean
...
infra-check: ## Verify credential-free GCP infrastructure contracts
	@python3 tools/infra/check_gcp_contract.py
